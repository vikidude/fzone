    ...
    return (
        <View
            ...
            <View style={{ marginVertical: 3, flexDirection: 'row', justifyContent: 'space-around', paddingHorizontal: width * 0.03 }}>
                <Text style={{ fontSize: props.btnSize, flexGrow: 1, color: 'black' }}>
                    {props.planName}
                </Text>
                <Text style={{ fontSize: props.btnSize, flexGrow: 1, color: 'black', textAlign: 'right' }}>
                    {props.planLimit}
                </Text>
            </View>
            <Text style={{ fontSize: props.btnSize, flexGrow: 1, color: 'black', paddingHorizontal: width * 0.03 }}>
                {props.planBy}
            </Text>
            <FlatList
