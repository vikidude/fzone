    ...
    return (
        <View style={{ flex: 1, padding: width * 0.03, backgroundColor: 'white' }}>
            ...
            <View style={{ flex: 1, alignItems: 'center' }}>
                <Text style={{ fontSize: width * 0.09,fontFamily: font.bold, color: 'black' }}>
                    Ready to go!
                </Text>
                <Text style={{ color: 'grey', fontSize: width * 0.065,fontFamily: font.regular }}>
                    {exe_name}
                </Text>
                <Image source={exe_img} style={{ width: width * 0.8, height: height * 0.5, resizeMode: 'center' }} />
                <Text style={{ color: 'black', fontSize: width * 0.1, marginTop: height * 0.02,fontFamily: font.regular }}>
                    {counter}
                </Text>
                <Text style={{ color: 'blue', fontSize: width * 0.05, marginVertical: height * 0.04,fontFamily: font.regular }}>
                    Skip
                </Text>
            </View>
        </View>
